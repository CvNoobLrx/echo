...
export interface DailyReviewData {
  ...
  content: string
  care: string
  stats: { messages: number; memories: number; documents: number }
  status: string
  created_at: string | null
}
...
export const dashboardApi = {
  dailyReview() {
    return client.get<unknown, Wrapped<DailyReviewData>>('/dashboard/daily-review')
  },
  regenerateDailyReview() {
    return client.post<unknown, Wrapped<DailyReviewData>>('/dashboard/daily-review/regenerate')
  },
  overview() {
