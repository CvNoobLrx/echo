...
const KEY_LABELS: Record<string, string> = {
  ...
  'echo.chat.iteration': '对话轮次',
  'echo.chat.tools_bound': '可用工具数',
  'echo.chat.mode': '调用模式',
  'echo.tool.name': '工具',
  'echo.tool.query': '查询内容',
  'echo.tool.provider': '工具来源',
  'echo.retrieval.query_count': '检索角度数',
  'echo.retrieval.hit_count': '命中条数',
  'echo.verifier.kind': '审稿模式',
  'echo.verifier.rubric': '评分规则',
  'echo.loop.iteration_no': '回炉轮次',
  'echo.repair.action': '修复策略',
  'echo.vision.mime': '图片类型',
  'echo.rerank.doc_count': '待重排数',
  'echo.rerank.top_n': '返回前 N',
  'echo.distill.source_count': '来源数',
  'echo.curator.section_count': '章节数',
  'echo.curator.learning_count': '要点数',
  batch_size: '批量大小',
