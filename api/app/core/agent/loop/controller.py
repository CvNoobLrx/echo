...
设计:
- Controller 不直接 import research engine / chat service,通过 ctx 里的回调解耦
...
from app.core.agent.tracing.otel_attrs import (
    ECHO_LOOP_ITERATION_NO,
    ECHO_REPAIR_ACTION,
    ECHO_VERIFIER_KIND,
    ECHO_VERIFIER_RUBRIC,
)
            ...
            while True:
                ...
                try:
                    async with tracer.span(
                        ...
                        span_type="verifier",
                        attributes={
                            ECHO_LOOP_ITERATION_NO: iteration_no,
                            ECHO_VERIFIER_KIND: verifier_kind,
                            ECHO_VERIFIER_RUBRIC: self.rubric_name,
                        },
                    ) as vsp:
                ...
                try:
                    async with tracer.span(
                        ...
                        attributes={
                            ECHO_LOOP_ITERATION_NO: iteration_no,
                            ECHO_REPAIR_ACTION: action.kind,
                        },
                    ) as rsp:
