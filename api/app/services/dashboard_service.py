...
class DashboardService:
    ...
    async def _entity_count(self, user_id: str) -> int:
        """从 Neo4j 取实体数。失败返回 0。"""
        try:
            ...
            return await MemoryGraphRepository().count_entities(user_id)
    ...
    async def overview(self, user_id: uuid.UUID) -> dict:
        ...
        entity_cnt = await self._entity_count(str(user_id))
